...
public class Upload extends AppCompatActivity {
    ...
    public void saveData() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Tigers")
    ...
    public void uploadData() {
        ...
        databaseReference.child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    // Upload to Firestore
                    firestore.collection("Tigers").document(title)
                            .set(dataClass)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Upload.this, "Firestore Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    Toast.makeText(Upload.this, "Realtime Database Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
